...
class Gdpr_Cookie_Consent_Admin {
	...
	public function admin_settings_page() {
		...
		$cookie_fetch_data                   = apply_filters( 'gdpr_cookie_fetch_params', '' );
		wp_localize_script(
			...
			array(
				...
				'cookie_fetch_data_params'         => $cookie_fetch_data,
	...
	public function gdpr_cookie_consent_ajax_save_settings() {
		if ( isset( $_POST['gcc_settings_form_nonce'] ) ) {
			...
			$the_options['button_accept_all_text']               = isset( $_POST['gcc-accept-all-text'] ) ? sanitize_text_field( wp_unslash( $_POST['gcc-accept-all-text'] ) ) : 'Accept All';
